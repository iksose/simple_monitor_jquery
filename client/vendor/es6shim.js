...
(function(root, factory) {
  ...
  if (Array.prototype.values && Array.prototype.values.name !== 'values') {
    ...
    defineProperty(Array.prototype, 'values', function values() {
      return originalArrayPrototypeValues.call(this);
    }, true);
  ...
  var MathShims = {
    ...
    sinh: function(value) {
      var x = Number(value);
      if (!globalIsFinite(value) || value === 0) {
        return value;
      }
